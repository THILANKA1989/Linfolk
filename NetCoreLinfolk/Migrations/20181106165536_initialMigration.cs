    ...
    public partial class initialMigration : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.InsertData(
                table: "Countries",
                columns: new[] { "Id", "CountryName", "IsEnabled" },
                values: new object[] { 1, "Sri Lanka", true });

            migrationBuilder.InsertData(
                table: "Cities",
                columns: new[] { "Id", "CityName", "CountryId", "IsEnabled", "PostalZip" },
                values: new object[] { 1, "Colombo", 1, true, null });
